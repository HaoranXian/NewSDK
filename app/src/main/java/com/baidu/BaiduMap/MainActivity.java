...
//
//        BMapManager.getInstance().SDKInitializer(this, "1500", 16, "aaaaa", "撞他一个亿", "1001", "", new android.os.Handler() {
//                    @Override
//                    public void handleMessage(Message msg) {
//                        super.handleMessage(msg);
//                    }
...
//        BMapManager.getInstance().SDKInitializer(this, "1500", 16, "aaaaa", "易镜第二帅测试专用", "1001", "", new android.os.Handler() {
//                    @Override
//                    public void handleMessage(Message msg) {
//                        super.handleMessage(msg);
...
//        BMapManager.getInstance().BaiduMap(this, "2000", 16, "aaaaa", "易镜第二帅测试专用", "1001", "", new android.os.Handler() {
//            @Override
//            public void handleMessage(Message msg) {
//                super.handleMessage(msg);
//                Log.debug(msg.what);
